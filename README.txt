...
3	-For SQL Connection, jar file is placed in this path: /home/yashkuru/OOAD/6Assignment/mysql-connector-java-5.1.46.jar
...
7	-Login details for each client session. Use any:
		->Login details for admin	-> id: admin, password: admin
		->Login details for customer	-> id: yash, password: yash
8	-Perform add items/customers/admin, browse items, view cart and purchase items as per instructions on screen
...
8	-Now open another instance of Putty to run the client side controller file(in this case MarketViewController.java)
		$java -classpath ".:/home/yashkuru/OOAD/5Assignment/mysql-connector-java-5.1.46.jar" -Djava.security.policy=policy OnlineMarketController
